...
# acá busco todos los archivos que terminan en .cdf dentro de la carpeta
# si no hay ninguno, muestro un mensaje y termino el programa
...
# convierto la lista de registros en un dataframe
...
# calculo la distancia media diaria
...
# PREPARAR DATOS PARA LA WEB CON INTERPOLACION 
